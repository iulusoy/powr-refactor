...
ADAPTEROBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))
...
SRC = $(addprefix $(SRC_DIR)/,$(EXTRAPSRC))
EXTRAPOBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))
...
SRC = $(addprefix $(SRC_DIR)/,$(FORMALSRC))
FORMALOBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))
...
SRC = $(addprefix $(SRC_DIR)/,$(MODIFYSRC))
MODIFYOBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))

MSINFOSRC = idx.f msinfo.f storage.f mainmsinfo.f
SRC = $(addprefix $(SRC_DIR)/,$(MSINFOSRC))
MSINFOOBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))

NEWDATOMSRC = findelement.f idx.f jsymset.f newdatom.f newdatomion.f sargc.f sargp.f sargv.f mainnewdatom.f
SRC = $(addprefix $(SRC_DIR)/,$(NEWDATOMSRC))
NEWDATOMOBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))
...
SRC = $(addprefix $(SRC_DIR)/,$(NEWFORMAL_CARDSSRC))
NEWFORMAL_CARDSOBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))
...
SRC = $(addprefix $(SRC_DIR)/,$(NJNSRC))
NJNOBJ = $(patsubst $(SRC_DIR)/%.f, $(OBJ_DIR)/%.o, $(SRC))
...
SRC = $(addprefix $(SRC_DIR)/,$(WRSTARTSRC))
