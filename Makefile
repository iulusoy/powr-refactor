...
FFLAGS_DEBUG = -integer-size 64 -real-size 64 -I${LIB_DIR} -assume byterecl -save -extend-source -O0 -fpe:0 -traceback -mcmodel=medium -g -fp-model strict -module ${MODULE_DIR}
FFLAGS_DEBUG_colimo = -integer-size 64 -real-size 64 -I${LIB_DIR} -assume byterecl -extend-source -O0 -fpe:0 -traceback -mcmodel=medium -g -fp-model strict -warn all -check all
...
STEALMOD = params.f90 linpop_arrays.f90
