...
C***  WRONG KEYWORD KEYCBB
      ...
      ELSE
         ...
         WRITE (0,*) '*** ERROR: WRONG KEYWORD KEYCBB '
         WRITE (0,*) '*** ERROR DETAILS'
         WRITE (0,'(A, I7)') 'IND =', IND
         WRITE (0,'(A, I7)') 'LOW =', LOW
         WRITE (0,'(A, I7)') 'NUP =', NUP
         WRITE (0,'(A, A )') 'KEY =', KEYCBB(IND)
      call trbk
         STOP '*** FATAL ERROR detected in subr. CBBMORE'
