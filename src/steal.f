...
C***  HANDLING OF DIELECTRONIC RECOMBINATION / AUTOIONIZATION (SUBR. DATOM)
     ...
     >                          ETA, THOMSON, VELO, OLDVELO, OLDRADI,
     ...
     >                          HTOTCUT, HTOTE, HTOTCMF0ADV
      ...
      REAL, DIMENSION(NDDIM, NDIM) :: POP2, POP3
      REAL, DIMENSION(NDIM) :: ENOLD, 
     >                         DEPARTNDorg
      INTEGER, DIMENSION(NDIM) :: MAINQN, NOM, IONGRND
      REAL, DIMENSION(NDIM, NDIM) :: CRATE, DCRATEDT, RRATE
     ...
     >                            ADDCON1, ADDCON2, ADDCON3
      REAL, DIMENSION(NFDIM) :: EMFLUX, EMCOLI 
      REAL, DIMENSION(NDDIM,NFDIM) :: XJCorg
...
C OLD> DIMENSION SCRATCH(2*NDIMP2), ATEST(NDIMP2,NDIMP2)
      ...
      REAL, DIMENSION(NDIMP2) :: BRS, BRSP, BRY, DTEST
      REAL, DIMENSION(NDIMP2,NDIMP2) :: RATCO, AOFF, ATEST, BTEST
...
C***    SOLUTION OF THE NON-LINEAR SET OF RATE EQUATIONS
        CALL  LINPOP (N,NF,ALOMIN,bLAMAPPCOLI,GAMMAC,GAMMAL,EPSILON, 
